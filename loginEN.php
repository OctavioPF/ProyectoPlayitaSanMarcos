        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <h1>Login</h1>
                    <hr>
                    <form id="form1" name="form1" method="post" action="altaProductos.php">
                        <table>
                            <tr>
                                <td><label for="txt_Usuario">User</label></td>
                                <td><input type="text" name="txt_Usuario" id="txt_Usuario"
                                        onkeyup="javascript:this.value=this.value.toLowerCase();" required/></td>
                            </tr>
                            <tr>
                        ...
                        <p><input type="submit" name="btn_Entrar" id="btn_Entrar" value="Get in" /></p>
                        <p>&nbsp;</p>
                    </form>
                </div>
            </div>
