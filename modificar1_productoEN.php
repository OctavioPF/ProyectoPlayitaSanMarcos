...
<body>
  <div class="container" id="container">
    <div id="header">
      <h1>Enter the data to modify</h1>
    </div>
    <div class="page-section" id="content">
      <div class="page-section cta" id="section">
        ...
        ?>
          ...
          <form id="form1" name="form1" method="post" action="actualizar_productoEN.php" onsubmit="return validarForm1(this);">
            ...
            <p><label for="txt_Nombre"><b>Product name </b></label><br>
              ...
              <input type="text" name="txt_Nombre" id="txt_Nombre"
                onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $row->nomProducto; ?>">
            </p>
            <p>
